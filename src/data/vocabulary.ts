...
export const VOCAB_SECTIONS: VocabSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { ro: "apă", en: "water" }, { ro: "scaun", en: "chair" }, { ro: "dulap", en: "closet/wardrobe" },
  ...
  },
  {
    ...
    items: [
      ...
      { ro: "farmacie", en: "pharmacy" }, { ro: "piață", en: "market" }, { ro: "bancă", en: "bank" },
      ...
      { ro: "biserică", en: "church" }, { ro: "piață", en: "square" }, { ro: "pod", en: "bridge" },
      { ro: "clădire", en: "building" }, { ro: "colț", en: "corner" }, { ro: "semafor", en: "traffic light" },
      { ro: "trecere de pietoni", en: "crosswalk" }, { ro: "centru", en: "center" },
    ],
  },
  {
    icon: "🚗",
  ...
  },
  {
    ...
    items: [
      ...
      { ro: "sărbătoare", en: "holiday/celebration" }, { ro: "cadou", en: "gift" }, { ro: "petrecere", en: "party" },
    ],
  },
  {
    icon: "⏰",
    ...
    items: [
      ...
      { ro: "întrebare", en: "question" }, { ro: "povestea", en: "the story" }, { ro: "loc", en: "place" },
    ],
  },
];
...
export const HEALTH_PHRASES: PhraseItem[] = [
  ...
  { ro: "Sunt alergic(ă) la...", en: "I'm allergic to..." },
];
...
export const ADVERBS: VocabSection["items"] = [
  ...
  { ro: "imediat", en: "immediately" }, { ro: "exact", en: "exactly" }, { ro: "sigur", en: "sure/certainly" },
...
export const COGNATES: VocabSection["items"] = [
  ...
  { ro: "organizație", en: "organization" }, { ro: "prezentație", en: "presentation" },
  ...
  { ro: "problem", en: "problem" }, { ro: "moment", en: "moment" },
  { ro: "document", en: "document" }, { ro: "transport", en: "transport" },
  { ro: "gardă", en: "guard" }, { ro: "modern", en: "modern" },
  { ro: "normal", en: "normal" }, { ro: "special", en: "special" },
  { ro: "popular", en: "popular" }, { ro: "important", en: "important" },
  { ro: "interesant", en: "interesting" }, { ro: "diferit", en: "different" },
  { ro: "posibil", en: "possible" }, { ro: "imposibil", en: "impossible" },
];
